...
5. Executar o docking proteína-proteína com o [HADDOCK2.4](https://rascar.science.uu.nl/haddock2.4/).
...
##### Modelagem do complexo proteína-proteína 

1. Predição da Estrutura do Complexo: Realizar a predição estrutural do complexo (Fv-PD-1) usando o [Protenix](https://protenix-server.com/model/prediction/add).

##### Análise das interações 

1. Realizar a predição de interações usando o servidor [RING 4.0](https://ring.biocomputingup.it/)
